...
public class QuizActivity extends AppCompatActivity {
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Toast.makeText(QuizActivity.this, "Memuat Hasil =)", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
             Toast.makeText(QuizActivity.this, "Cling! Jawaban Anda Benar!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(QuizActivity.this, "Tetot! Jawaban Anda Salah!", Toast.LENGTH_SHORT).show();
